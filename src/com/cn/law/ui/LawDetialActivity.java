...
public class LawDetialActivity extends BaseActivity {
	...
	public void onClick(View v) {
		...
		case R.id.share_img:
			...
			Intent intent=new Intent(LawDetialActivity.this,MySharedActivity.class);
	...
	case R.id.commend_img:
		Intent intentc=new Intent(LawDetialActivity.this,MyCommendActivity.class);
		intentc.putExtra("data", data.getFid());
